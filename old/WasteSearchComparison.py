...
# -*- coding: utf-8 -*-
"""
I made this for comparing the results from WasteSearch in ei38 vs ei39
...
files = [x for x in os.listdir(path) if ".csv" in x and "WasteSearch" not in x]
...
unique.to_csv((path+ "/WasteSearchCombined.csv"), sep=";", header=True)
